...
class LocationUtils private constructor() {
    ...
    companion object {
        ...
        fun register(minTime: Long, minDistance: Long, listener: OnLocationChangeListener?): Boolean {
            ...
            mLocationManager = Utils.app.getSystemService(LOCATION_SERVICE) as LocationManager?
            if (mLocationManager == null || !mLocationManager!!.isProviderEnabled(LocationManager.NETWORK_PROVIDER) && !mLocationManager!!.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
